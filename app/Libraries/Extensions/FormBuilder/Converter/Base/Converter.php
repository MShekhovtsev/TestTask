...
use App\Libraries\Extensions\FormBuilder\Converter\JqueryValidation\Message;
use App\Libraries\Extensions\FormBuilder\Converter\JqueryValidation\Route;
use App\Libraries\Extensions\FormBuilder\Converter\JqueryValidation\Rule;
...
abstract class Converter {
	...
	{
        if(strpos($attribute, 'translatable') !== false) {
        ...
        if($this->model){
            $attribute = $this->model->label($attribute);
        }
